...
import com_urbandecay_Page.OrderHistory_Page;
...
public class UserProfileTest extends BaseTest {
	...
	public void VerifyUpdateAddress() throws Exception {
		...
		OrderHistory_Page OHP = new OrderHistory_Page(driver);
		...
		String s = OCP.getOrderNumber();
		Assert.assertEquals(b, true);
		OHP.navigateOrderHistoryPage();
		OHP.clickOnOrder(s);
		OHP.verifyOrderDetailPage(s);
